...
DebianDC does not assume that `/etc/resolv.conf` is a permanent, “owned” file. <br>
On Debian systems, DNS configuration may be modified during boot and interface <br>
