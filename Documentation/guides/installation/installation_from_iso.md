...
![alt text](https://github.com/eesmer/DebianDC/blob/master/Documentation/assets/screenshots/handbook/install-1.png "DebianDC Install")

The screen that started the installation.<br>
You can start the installation by pressing the enter button on this screen.

![alt text](https://github.com/eesmer/DebianDC/blob/master/Documentation/assets/screenshots/handbook/install-2.png "DebianDC Install")

You can continue by adjusting the location and keyboard settings.

![alt text](https://github.com/eesmer/DebianDC/blob/master/Documentation/assets/screenshots/handbook/install-3.png "DebianDC Install")

You can set a machine name

![alt text](https://github.com/eesmer/DebianDC/blob/master/Documentation/assets/screenshots/handbook/install-4.png "DebianDC Install")

The domain name is asked after the machine name.<br>
Leave this blank

![alt text](https://github.com/eesmer/DebianDC/blob/master/Documentation/assets/screenshots/handbook/install-5.png "DebianDC Install")

Set password for root user<br>
You will be logged into the system by this

![alt text](https://github.com/eesmer/DebianDC/blob/master/Documentation/assets/screenshots/handbook/install-6.png "DebianDC Install")

At this stage, the installation will start and then it will ask you to set the repo address for the package archive.

![alt text](https://github.com/eesmer/DebianDC/blob/master/Documentation/assets/screenshots/handbook/install-7.png "DebianDC Install")
...
![alt text](https://github.com/eesmer/DebianDC/blob/master/Documentation/assets/screenshots/LoginScreen-SS1.png "DebianDC Login")
